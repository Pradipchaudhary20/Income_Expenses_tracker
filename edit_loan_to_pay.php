...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE loans_to_pay SET amount = ?, name = ?, date = ? WHERE id = ?";
    ...
    $sql = "SELECT * FROM loans_to_pay WHERE id = ?";
    $stmt = $conn->prepare($sql);
...
<div class="main-content">
    ...
    <div class="form-container">
        <form method="POST" action="">
            ...
            <input type="number" id="amount" name="amount" value="<?php echo htmlspecialchars($loan['amount']); ?>" required>
            
            <label for="name">Name:</label>
            <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($loan['name']); ?>" required>
            
            <label for="date">Date:</label>
            <input type="date" id="date" name="date" value="<?php echo htmlspecialchars($loan['date']); ?>" required>
            
            <button type="submit">Update Loan To Pay</button>
        </form>
    </div>
</div>
</body>
